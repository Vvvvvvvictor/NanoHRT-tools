...
class puWeightProducer(Module):
    def __init__(self,
        ...
        try:
            ROOT.gSystem.Load("libPhysicsToolsNanoHRTTools")
        ...
        # same CMSSW directory
            ...
            if "/WeightCalculatorFromHistogram_cc.so" not in ROOT.gSystem.GetLibraries(
                ...
                ROOT.gROOT.ProcessLine(
                    ".L %s/src/PhysicsTools/NanoHRTTools/src/WeightCalculatorFromHistogram.cc++"
...
pufile_mc2016 = "%s/src/PhysicsTools/NanoHRTTools/python/postprocessing/data/pileup/pileup_profile_Summer16.root" % os.environ[
    'CMSSW_BASE']
pufile_data2016 = "%s/src/PhysicsTools/NanoHRTTools/python/postprocessing/data/pileup/PileupData_GoldenJSON_Full2016.root" % os.environ[
    'CMSSW_BASE']
...
pufile_data2017 = "%s/src/PhysicsTools/NanoHRTTools/python/postprocessing/data/pileup/PileupHistogram-goldenJSON-13tev-2017-99bins_withVar.root" % os.environ[
    'CMSSW_BASE']
pufile_mc2017 = "%s/src/PhysicsTools/NanoHRTTools/python/postprocessing/data/pileup/mcPileup2017.root" % os.environ[
    'CMSSW_BASE']
...
pufile_data2018 = "%s/src/PhysicsTools/NanoHRTTools/python/postprocessing/data/pileup/PileupHistogram-goldenJSON-13tev-2018-100bins_withVar.root" % os.environ[
    'CMSSW_BASE']
pufile_mc2018 = "%s/src/PhysicsTools/NanoHRTTools/python/postprocessing/data/pileup/mcPileup2018.root" % os.environ[
    'CMSSW_BASE']
...
# 2016
pufile_dataUL2016 = "%s/src/PhysicsTools/NanoHRTTools/python/postprocessing/data/pileup/PileupHistogram-UL2016-100bins_withVar.root" % os.environ[
    'CMSSW_BASE']
pufile_mcUL2016 = "%s/src/PhysicsTools/NanoHRTTools/python/postprocessing/data/pileup/mcPileupUL2016.root" % os.environ[
    'CMSSW_BASE']
...
# 2017
pufile_dataUL2017 = "%s/src/PhysicsTools/NanoHRTTools/python/postprocessing/data/pileup/PileupHistogram-UL2017-100bins_withVar.root" % os.environ[
    'CMSSW_BASE']
pufile_mcUL2017 = "%s/src/PhysicsTools/NanoHRTTools/python/postprocessing/data/pileup/mcPileupUL2017.root" % os.environ[
    'CMSSW_BASE']
...
# 2018
pufile_dataUL2018 = "%s/src/PhysicsTools/NanoHRTTools/python/postprocessing/data/pileup/PileupHistogram-UL2018-100bins_withVar.root" % os.environ[
    'CMSSW_BASE']
pufile_mcUL2018 = "%s/src/PhysicsTools/NanoHRTTools/python/postprocessing/data/pileup/mcPileupUL2018.root" % os.environ[
    'CMSSW_BASE']
